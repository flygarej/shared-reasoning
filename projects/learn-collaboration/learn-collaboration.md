...
<!-- projects/learn-collaboration/state/project-state.md -->
...
<!-- projects/learn-collaboration/state/session-log.md -->
...
<!-- projects/learn-collaboration/state/TODO.md -->
...
# Potential changes to project-state.md

## Teach collaboration through collaboration.

The methodology itself should preferably emerge from examples, experiments, and shared investigation rather than being presented as a fixed set of rules. A learner should experience the habits before studying the abstractions that describe them.

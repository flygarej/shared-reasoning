...
nMname1,name2$⃝ $⃝   Set to read from the beginning of file name1, name2 on
...
(a1)	To load the program APLHA RALPHA from DECtape unit 3, the program
	...
	3MALPHA RALPHA$⃝L2MSUBR 1$⃝LMSUBR 2$⃝L?$⃝ $⃝
...
(c)	To load PROG REL from DECtape unit 1 and the requested library
	...
	1MPROG REL$⃝L4MLIBRAR 1$⃝N$⃝ $⃝
</pre>
...
it must be a bracketed word. If syllable1 is virtual, or has ① relocation,
the value of syllable2 must be less than 2<sup>10</sup>.

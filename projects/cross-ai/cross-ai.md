...
<!-- projects/cross-ai/state/project-state.md -->
...
<!-- projects/cross-ai/state/session-log.md -->
...
<!-- projects/cross-ai/state/TODO.md -->

# Fresh Project TODO

## Goal
Establish enough accepted project knowledge that another collaborator can continue the investigation without replaying the original conversation.
...
- Distinguish observation, documentation, inference, hypothesis, working model, and verified conclusion.
...
<!-- projects/cross-ai/domain/domain.md -->

# Domain knowledge

## Placeholder

Initial domain space for the `cross-ai` project.

Use this directory to add generators, anchors, boundaries, and reference material as the investigation reveals stable conceptual knowledge about cross-platform startup behavior and collaboration friction.

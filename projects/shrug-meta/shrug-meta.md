...
<!-- projects/shrug-meta/state/project-state.md -->

# project-state.md

## Project
**SHRUG Meta** — Shared Reasoning methodology

## Objective

Study, refine and validate the Shared Reasoning methodology itself rather
than a technical domain.
...
- `state/` — accepted project knowledge and chronology.
- `domain/` — compact conceptual model.
- `observations/` — project-local observations that have not yet been
  promoted into accepted knowledge.

Observations are intentionally lightweight. They provide an incubation
stage for ideas, recurring behaviours and empirical findings before they
are promoted into project state, generators, anchors or boundaries.

## Accepted Observations

- Shared Reasoning has been successfully applied to multiple long-running
  technical projects.
- GBA appears to reduce contextual clutter while preserving
  reconstruction quality.
- Different LLMs reconstruct similar knowledge while exhibiting different
  collaboration styles.
- Fresh collaborators requested missing project state rather than
  inventing one.

## Working Models

- GBA is a compact conceptual representation reconstructed through
  constrained inference.
- Human or externally grounded observations remain the epistemic
  linchpin.
- Future agent execution may provide grounded observations if their
  verification scope is explicit.

## Community

**SHRUG — Shared Reasoning User Group** is the informal community that
shares observations and helps evolve the methodology through evidence.

## Open Questions

- Representation of per-model observations.
...
Digest initial observations into the first stable generators.


<!-- projects/shrug-meta/state/session-log.md -->

# session-log.md

## Initial Session

Bootstrap of the SHRUG Meta project.

### Evidence

- Repository assessment by GitHub Copilot.
- Discussion of Shared Reasoning evolution.
- Cross-model behavioural observations.
- Discussion of GBA representation.
- Discussion of future LLM-agent and LLM-LLM collaboration.

### Decisions

- Treat methodology evolution as its own project.
- Keep protocol stable unless supported by observed behaviour.
- Introduce SHRUG (Shared Reasoning User Group) as the informal
  community surrounding the methodology.
- Investigate an observations layer for model-specific findings.

### Outstanding Work

- Build initial methodology domain capsule.
- Classify observations versus working models.
- Continue gathering evidence from multiple LLMs.


<!-- projects/shrug-meta/state/TODO(3).md -->
...
<!-- projects/shrug-meta/state/TODO.md -->
...
<!-- projects/shrug-meta/domain/domain.md -->
...
<!-- projects/shrug-meta/domain/shrug-meta-domain.md -->

# shrug-meta-domain.md

# Generator: Shared Reasoning Evolution

The methodology evolves from observed collaboration rather than design.

New abstractions should explain multiple observed behaviours while
reducing workflow friction.

## Generator: Epistemic Grounding

Accepted knowledge ultimately depends on externally grounded
observations.

Inference organizes knowledge but does not replace evidence.

## Boundary

Do not promote stylistic preferences or individual model behaviour into
the protocol without repeated supporting observations.

## Candidate Anchors

- Human or externally grounded observations are the epistemic linchpin.
- GBA reduces representation size while preserving conceptual
  reconstruction.
- SHRUG provides the collaborative feedback loop through which the
...
This directory records project-local observations that may improve the
Shared Reasoning methodology but have not yet been promoted into accepted
project knowledge.
...
An observation may eventually become:

- project-state;
- a generator;
- an anchor;
- a boundary;
- or remain an observation if additional evidence is needed.

The objective is to preserve useful evidence without prematurely turning
it into accepted knowledge.

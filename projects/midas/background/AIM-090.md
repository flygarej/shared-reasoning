...
name=word<span title="bent return/down-arrow symbol in original">↵</span>		makes name a symbol with value, relocation and
			virtuality of word.

name==word<span title="bent return/down-arrow symbol in original">↵</span>		same as name=word<span title="bent return/down-arrow symbol in original">↵</span>, but also has the effect, when
...
word<span title="bent return/down-arrow symbol in original">↵</span>|		     word is taken as a storage word.
	  |
...
RADIX <span title="triangle separator symbol in original">△</span> word<span title="bent return/down-arrow symbol in original">↵</span>	Sets current radix to value of word.
...
EQUALS<span title="triangle separator symbol in original">△</span>name1<span title="triangle separator symbol in original">△</span>name2<span title="bent return/down-arrow symbol in original">↵</span>
			name1 is made a synonym of name2 and may
			be used anywhere instead of name2. This
			pseudoinstruction is generally used upon
			macros and pseudoinstructions rather than
			symbols.

TITLE<span title="triangle separator symbol in original">△</span>string lf	The string of characters through the first
...
SQOZE<span title="triangle separator symbol in original">△</span>field,symbol	Is a syllable with value equal to the radix-50
			representation of symbol plus &lt;field &amp; 17&gt;&lt;-30

ASCII_jtextj		where j is any ASCII character, and text is
...
REPEAT<span title="triangle separator symbol in original">△</span>field<span title="triangle separator symbol in original">△</span>text<span title="carriage return">CR</span>	 (where text is any character string whose
...
REPEAT<span title="triangle separator symbol in original">△</span>field<span title="triangle separator symbol in original">△</span>[text]	 Finds n, the value of field; then passes
...
The following pseudoinstructions, whose names begin IF, are termed conditional
assembly pseudoinstructions.

IF1<span title="triangle separator symbol in original">△</span>text<span title="carriage return">CR</span>		(take text argument like that of REPEAT.)
IF1<span title="triangle separator symbol in original">△</span>[text]			The text is passed back as input if the
				assembler is performing Pass1. Otherwise
				this usage gives no characters out.

IF2<span title="triangle separator symbol in original">△</span>text<span title="carriage return">CR</span>		Like IF1, but gives text back to input only
IF2<span title="triangle separator symbol in original">△</span>[text]			if performing Pass 2

IFE<span title="triangle separator symbol in original">△</span>field<span title="triangle separator symbol in original">△</span>text<span title="carriage return">CR</span>	If the numeric value of field is equal to 0,
IFE<span title="triangle separator symbol in original">△</span>field<span title="triangle separator symbol in original">△</span>[text]	the text is reprocessed as input; otherwise not.
...
IRP<span title="triangle separator symbol in original">△</span>A, B, [P,Q,R]<span title="bent return/down-arrow symbol in original">↵</span>	The IRP pseudoinstruction takes a triplet of
...
IRPC<span title="triangle separator symbol in original">△</span>A,B,[string]<span title="bent return/down-arrow symbol in original">↵</span>	Here A and B are dummy symbols, and string
...
<span title="bent return/down-arrow symbol in original">↵</span> character, but if that character is <span title="carriage return">CR</span> and the next character is <span title="line feed">LF</span> the <span title="line feed">LF</span>
...
symbol occurence in the body are examined: each of which is an exclamation
...
WORD<span title="triangle separator symbol in original">△</span>wrd<span title="bent return/down-arrow symbol in original">↵</span>     The value of wrd is output as a 36-bit word. In
...
.LIFL<span title="triangle separator symbol in original">△</span>word<span title="bent return/down-arrow symbol in original">↵</span>   In each case the word is evaluated by the Loader,
...
.LIFGE<span title="triangle separator symbol in original">△</span>word<span title="bent return/down-arrow symbol in original">↵</span>  only if the value of word is respectively
...
(<span title="ALT MODE / escape">ESC</span> will be used as a symbol for ALT MODE.) In normal use, one should give
